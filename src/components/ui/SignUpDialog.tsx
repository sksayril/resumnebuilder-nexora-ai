...
export const SignUpDialog: React.FC<SignUpDialogProps> = ({ open, onOpenChange, onSignUp }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch('https://7cvccltb-3300.inc1.devtunnels.ms/api/signUp', {
        method: 'POST',
        headers: {
          ...
          {open && (
            <>
              ...
              <Dialog.Content>
                ...
                >
                  <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl p-8 max-h-screen max-w-md w-full border border-gray-200 dark:border-gray-800">
                    <div className="space-y-6">
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="securityQuestion" className='text-black'>Security Question</Label>
                          <select
                            id="securityQuestion"
                            value={securityQuestion}
                            onChange={e => setSecurityQuestion(e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 text-black dark:text-black dark:bg-gray-800 dark:border-gray-700"
                            required
                          >
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="securityAnswer" className='text-black'>Answer</Label>
                          <Input
                            id="securityAnswer"
                            type="text"
                      ...
                      <Button
                        ...
                        onClick={() => {
                          onOpenChange(false);
                          // The parent component will handle showing the login dialog
                        }}
                      >
